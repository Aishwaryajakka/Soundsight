...
export interface SoundSightMarkProps {
  size?: number;
  className?: string;
  variant?: 'dark-background' | 'light-background';
}

export const SoundSightMark: React.FC<SoundSightMarkProps> = ({ size = 36, variant = 'dark-background' }) => (
  <Svg width={size} height={size} viewBox="0 0 120 120" accessibilityRole="image" accessibilityLabel="SoundSight">
    ...
    <Path
      d="M13 45 A51 51 0 0 1 107 45"
      fill="none"
      stroke={variant === 'dark-background' ? '#A7E7F8' : '#247CA8'}
      strokeWidth="14"
      strokeLinecap="butt"
    />
    <G clipPath="url(#ss-clip)">
      <Path d="M1 49 C22 59 35 26 57 25 C76 24 77 57 96 51 C107 47 116 52 123 60 L123 121 L1 121 Z" fill="#DFF7FD" />
      <Path d="M0 57 C23 67 37 35 59 34 C78 33 80 66 99 59 C109 55 117 60 124 68 L124 121 L0 121 Z" fill="#91E2F7" opacity={0.96} />
      <Path d="M0 66 C23 76 40 45 61 44 C81 44 83 76 102 68 C112 64 119 69 125 77 L125 121 L0 121 Z" fill="#4BC8F1" opacity={0.9} />
      ...
      <Path d="M0 57 C23 67 37 35 59 34 C78 33 80 66 99 59 C109 55 117 60 124 68" fill="none" stroke="#E6FAFF" strokeWidth="1.3" />
